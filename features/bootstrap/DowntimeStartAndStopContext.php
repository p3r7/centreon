...
class DowntimeStartAndStopContext extends CentreonContext
{
    ...
    public function aRecurrentDowntimeStartingOnSummerChangingTime()
    {
        ...
        $this->container->execute(
            "wget http://li.nux.ro/download/nux/misc/el7/x86_64//libfaketime-0.9.6-2.el7.nux.x86_64.rpm",
            'web'
        );
        $this->container->execute(
            "rpm -Uvh libfaketime-0.9.6-2.el7.nux.x86_64.rpm",
            'web'
        );
        /*
        $this->container->execute(
        ...
        $this->container->execute(
            "su - centreon -c \"faketime '2018-03-25 01:55:00' centcore > /dev/null 2>&1 &\" ",
            'web'
        );
        $this->container->execute(
            "killall centengine",
        ...
        $this->container->execute(
            "faketime '2018-03-25 01:55:00' httpd -k start",
            'web'
        );
        $this->container->execute(
            "su - centreon-engine -c \"faketime '2018-03-25 01:55:00' /usr/sbin/centengine /etc/centreon-engine/centengine.cfg > /dev/null 2>&1 &\"",
            'web'
        );
        */
     ...
     */
    public function summerTimeIsApproaching()
    {
        /* cron */
        $this->container->execute("faketime '2018-03-25 01:56:00' php /usr/share/centreon/cron/downtimeManager.php", 'web');
    }
